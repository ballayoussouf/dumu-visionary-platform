  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto px-4 py-8 prose prose-invert max-w-4xl">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.companyInfo')}</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.products')}</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.order')}</h2>
        <h3 className="text-xl font-bold mt-4 mb-2">{t('legal.cgv.order')}</h3>
        <ol>
        ...
        <h3 className="text-xl font-bold mt-4 mb-2">{t('legal.cgv.withdrawal')}</h3>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.pricing')}</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.payment')}</h2>
        <h3 className="text-xl font-bold mt-4 mb-2">{t('legal.cgv.payment')}</h3>
        <ul>
        ...
        <h3 className="text-xl font-bold mt-4 mb-2">{t('legal.cgv.storage')}</h3>
        <p>Les transactions sont sécurisées via Paypal. Aucune donnée bancaire n'est conservée par DULU Sarl.</p>

        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.delivery')}</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.withdrawal')}</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.warranty')}</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.data')}</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.disputes')}</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">{t('legal.cgv.facebook')}</h2>
