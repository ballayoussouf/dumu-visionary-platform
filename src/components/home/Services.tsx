          ...
          >
            <Card className="flex flex-col min-h-[500px] hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  {t("services.mediaBuying.description")}
                </CardDescription>
              </CardHeader>
